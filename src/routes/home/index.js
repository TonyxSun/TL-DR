...
const Home = () => {
	...
	return <div class={style.home_outside}>
		...
		<div class={style.home_inside}>
			<div class={style.textbox}>
				<textarea placeholder="Enter in some text!" value={value} onInput={onInput}></textarea>
			</div>
			<h3>Check out our extension for more!</h3>

			<div class={style.buttons}>
				<div class={style.item}>
					<Button onClick={update}>Let's tldr it!</Button>
				</div>
			</div>
		</div>
	</div>
